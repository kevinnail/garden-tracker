      ...
      >
          ...
          {taskTypes.map((tt) => (
            <Pressable
              ...
              style={[
                ...
                taskTypeId === tt.id && { backgroundColor: tt.color },
              ]}
        ...
        <View style={styles.chipRow}>
          {FREQ_OPTIONS.map((f) => (
            ...
            >
              <Text
                style={[styles.freqChipText, frequencyWeeks === f && styles.freqChipTextSelected]}
              >
                Every {f}w
              </Text>
            </Pressable>
        ...
        <View style={styles.stepperRow}>
          <Pressable style={styles.stepperBtn} onPress={() => setOffset((o) => Math.max(0, o - 1))}>
